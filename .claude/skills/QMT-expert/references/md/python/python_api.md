# 迅投 QMT Python API 说明文档

*Source: 迅投QMT极速策略交易系统_模型资料_Python_API_说明文档_Python3.pdf*
*Total pages: 172*
...
25 2021.03.18 中period和dividend_type默认值为follow
...
22 2020.06.18 象）中增加m_nTaskId（任务号）；新增CTaskDetail 任务对象
...
Python 模型 必须实现 的两个接口：** init()** 与 handlebar() 。输出窗口展示了这个模型的运行输
...
联当前界面运行的产品。模型创建完毕后，加载用户编写的 Python 脚本，并调用 init() 初始化函数。模
...
名称           说明
NumPy
Pandas       NumPy (Numeric Python) 提供了许多高级的数值编程工具，如：矩阵数据类
Patsy        型、矢量处理，以及精密的运算库。专为进行严格的数字处理而产生。
SciPy
Statsmodels  Python Data Analysis Library 或 Pandas 是基于 NumPy 的一种工具，该工具是
TA_Lib       为了解决数据分析任务而创建的。Pandas 纳入了大量库和一些标准的数据模
             ...
             的库函数。例如线性代数、常微分方程数值求解、信号处理、图像处理、稀疏矩
             阵等等。
...
count 取   时间设置是否生  开始时间和结束时间设置效果
值         效
                   返回数量取决于开始时间与结束时间和count与结束时间
count >=  生效       的交集
0
          生效       同时设置开始时间和结束时间，在所设置的时间段内取值
count =
-1        生效       开始时间结束时间都不设置，取当前最新bar的值

count =   生效       只设置开始时间，取所设开始时间到当前时间的值
-1        生效
                   只设置结束时间，取股票上市第一根 bar 到所设结束时间
count =            的值
-1
...
<!-- page 53 -->
count  字段数        股票数          时间   返回类型
=-1    量          量            点    float
                  =1           =1   pandas.Series
       =1         =1           默认   pandas.DataFrame(字段数量和时间点不同时为
                               值    1)
...
数据都是上年度年报的财务数据,如果选择按照报告期取数,则上年度第4季度(上年度10月1日-12月31日)
的数据就是上年度报告期的数据.
...
（2）股票下单函数                                      释义
   函数名                                            指定手数交易
    order_lots                                    指定价值交易
    order_value                                   一定比例下单
    order_percent                                 目标价值下单
    order_target_value                            目标比例下单
    order_target_percent                          指定股数交易
    order_shares
...
1：按组合股票数量（份）
      ...
      *注：strategyName 只对同账号本地客户端有效，即 strategyName 只对当前客户端下的单进行
      ...
      触发下单交易；采用quickTrade参数设置为1时，非历史bar上执行时（ContextInfo.is_last_bar()
...
字段名          类型      释义与用例
fieldList
stockList    List（必  财报字段列表：['ASHAREBALANCESHEET.fix_assets', '利润
startDate    须）      表.净利润']
endDate
             List（必  股票列表：['600000.SH', '000001.SZ']
report_type  须）
             ...
             选）      为 'report_time' 为按照报告期取数据，' announce_time' 为
                     按照公告日期取数据
...
字段名          类型      释义与用例
tabname      Str（必   表名：'ASHAREBALANCESHEET'
colname      须）
market       Str（必   字段名：'fix_assets'
code         须）
             Str（必   市场：'SH'
report_type  须）
barpos       Str（必   代码：'600000'
             须）      报表时间类型，可缺省，默认是按照数据的公告期为区分取数据，设置为
...
处置固定资产、无形资产和其他长期投资收到的  net_cash_recp_disp_fiolta
现金
...
购建固定资产、无形资产和其他长期投资支付的  cash_pay_acq_const_fiolta
现金
...
处置固定资产、无形资产和其他长期资产支付的  fix_intan_other_asset_dispo_cash_payment
现金净额
报告截止日                  m_timetag
公告日                    m_anntime
...
沪市可交换公司债券质押券出入           133***,SH
库                                                                                                   109
沪市可交换公司债券换股              192***,SH
沪市并购重组私募债券挂牌转            1355**\|1356**\|1357**\|1358**\|1359**,SH                                  110
让
沪市证券公司短期债券挂牌转            1350**\|1351**\|1352**\|1353**\|1354**,SH                                  111
让
沪市信贷资产支持证券交易             128***,SH                                                                  112
asset-backed securities
沪市公司债券质押券入库              102***\|134***,SH                                                          113
沪市公司债                    122***\|123***\|124***\|127***\|136***,SH
沪市公开发行优先股交易              330***,SH                                                                  114
沪市非公开发行优先股转让             360***,SH                                                                  115
沪市公开发行优先股申购              770***,SH                                                                  116
沪市公开发行优先股配股/配售           771***,SH                                                                  117
沪市公开发行优先股申购款分            772***,SH                                                                  118
配                                                                                                   119
沪市公开发行优先股申购配号            773***,SH
沪市国债回购（席位托管方             201***,SH                                                                  120
式）
沪市企业债回购                  202***,SH                                                                  121
沪市国债买断式回购                203***,SH
沪市新质押式国债回购               204***,SH                                                                  122
沪市附息国债                   010***\|019***,SH
沪市金融债                    018***,SH                                                                  123
沪市贴现国债                   020***,SH                                                                  124
沪市中央政府债（国债）              010***\|019***\|020***,SH                                                  125
沪市分离债                    126***,SH                                                                  127
沪市资产证券化                  121***,SH                                                                  128
沪市信贷资产支持                 128***,SH                                                                  129
沪市企业债（席位托管方式）            120***\|129***,SH                                                          130
沪市可转债                    100***\|110***\|112***\|113***\|128***,SH                                  131
沪市地方债                    130***\|140***,SH                                                          132
沪市政府债（国债+地方债）            010***\|019***\|020***\|130***,SH                                          133
上海可交换私募债                 1380**,SH                                                                  134
沪市标准券                    888880\|SHRQ88,SH                                                          135
沪市封闭式基金                  500***\|5058**,SH                                                          136
沪市政策性金融债                 018***\|028***\|038***,SH                                                  137
沪市上海质押代码                 09****\|102***\|103***\|104***\|105***\|106***\|107***\|108***\|133***,SH  138
2000年前发行国债               009***,SH                                                                  139
                                                                                                    140
                                                                                                    141
                                                                                                    142
                                                                                                    143
...
类型描述             市场代码                                                                                               类别标
                                                                                                                    号
记账式贴现国债质押式回购标准   107***,SH
券入库                                                                                                                 144
公司债质押式回购标准券入库    1040**\|1041**\|1042**\|1043**\|1044**,SH
国债分销             7510**\|7511**,SH                                                                                  145
地方政府债质押式回购标准券入                                                                                                      146
库                106***\|141***,SH
地方政府债分销                                                                                                             147
分离债质押式回购标准券入库    75190*\|75191*\|75192*\|75193*\|75194*\|75195*\|75196*,SH
债券质押式报价回购        1050**\|1051**\|1052**\|1053**\|1054**\|1055**\|1056**\|1057*\|1058**,SH                           148
中小企业私募债券在固定收益平   205***,SH                                                                                          149
台转让                                                                                                                 150
跨境ETF            125***,SH
跨境LOF                                                                                                               151
上海创新型封闭式基金       513030\|513500\|513100\|510900\|513600\|513660,SH
上海的固定收益类         ,SH                                                                                                152
上海黄金             5058**,SH                                                                                          153
                 TF****\|T****\|HTFF****\|TF**\|T**\|HTFF**,IF                                                              30002
...
类型描述   类型集合                                      类别标
       沪市A股\|深市A股                                号
沪深A股   沪市B股\|深市B股                                100001
沪深B股                                             100002
沪深狭义股  沪深A股\|沪深B股                                100003
票                                                100004
沪深封基   沪市封基\|深市封基                                100005
指数     沪市指数\|深市指数                                100006
商品期货   上期\|大商\|郑商                                100007
期货市场   中金\|商品期货                                  100008
股票     沪市\|深市
深市中央政                                            100009
府债（国   深市附息国债\|深市贴现国债
债）                                               100010
深市政府债  深市中央政府债（国债）\|深市地方政府债                      100011
深市所有债  深市附息国债\|深市贴现国债\|深市地方政府债\|深市可转债\|深市企业      100012
券      债\|深市分离债\|深市私募债\|深市专项资金管理规划               100013
广义的股票  !指数                                       100014
ETF    沪市ETF\|深市ETF                              100015
封闭式基金  沪市封闭式基金\|深市封闭式基金                          100016
权证     沪市权证\|深市权证                                100017
债券     上海债券\|深市所有债券                              100018
深市国债回  深市国债回购(131900不是的，需要业务支持)&(!深市国债回购(131990  100020
购      不是的，需要业务支持))                              100021
标准券    沪市标准券\|深市标准券                              100022
债券回购   沪市国债回购（席位托管方式）\|深市国债回购                    100023
质押式回购  沪市新质押式国债回购\|深市国债回购                        100024
黄金     上海黄金\|深市黄金                                100025
实时申赎货
币基金    上海实时申赎货币基金\|深市实时申赎货币基金
货币基金
上海申购代  实时申赎货币基金\|上海交易型货币基金
码
...
类型描述   类型集合                                      类别标
跨境ETF                                            号
跨境LOF  深市跨境ETF\|跨境ETF                            100026
                                                 100027
可交易的   跨境LOF\|深市跨境LOF
                                                 100028
主板     沪深A股\|沪深封基\|ETF\|权证\|沪市申购\|深市创业板\|债券回购\|
回转交易   债券ETF\|上海的固定收益类\|黄金\|货币基金\|深市中央政府债（国      100029
上海配号   债）\|沪市中央政府债（国债）\|沪市地方债\|深市地方政府债\|上海申      100030
沪深新股申  购代码\|沪市上海质押代码\|跨境ETF\|跨境LOF\|上海配股代码\|上海   100031
购额度    配转债代码\|深市可转债\|沪市可转债\|沪增发股\|深增发股
沪深配股代
码      沪市A股\|深市主板
固定收益：
跟踪债券指  债券\|黄金\|上海的固定收益类\|权证\|跨境ETF\|跨境LOF\|上海交易
数的交易型  型货币基金
开放式指数
基金、交易  上海新股配号\|上海配售首发配号\|上海可转债资金申购配号
型货币市场
基金     沪新股额\|深新股额                                100032

固定收益类  上海配股代码\|深圳配股                              100033

分级基金   上海的固定收益类                                  100034
LOF
债券ETF  沪市附息国债\|深市附息国债\|沪市贴现国债\|深市贴现国债\|沪市政府      100035
       债（国债+地方债）\|深市政府债\|深市企业债\|沪市企业债（席位托管方
上海债券   式）\|深市私募债\|沪市可转债\|深市可转债\|沪市分离债\|深市分离债     100036
       \|债券回购\|标准券\|货币基金\|上海的固定收益类               100037
1天逆回购                                            100038
2天逆回购  上海分级基金\|深市分级基金
                                                 100039
       上海LOF\|深市LOF
                                                 100040
       上海债券ETF\|深圳债券ETF                          100041
