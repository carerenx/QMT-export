...
# 默认300天回看，输出到output/
python .claude/skills/signal-validation/driver.py 601869

# 自定义回看天数
python .claude/skills/signal-validation/driver.py 601869 500

# 自定义输出目录
python .claude/skills/signal-validation/driver.py 600519 300 output
```
