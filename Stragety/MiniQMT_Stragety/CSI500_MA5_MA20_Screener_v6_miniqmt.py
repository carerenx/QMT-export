# -*- coding: gbk -*-
"""MiniQMT CSI 500 MA screener v6 with valid-history detection."""
...
def _valid_completed_closes_by_code(history, codes, today_key):
    return {
        code: _valid_closes(
...
def main():
    ...
    if not connector.connect_data():
        return 1
    try:
        print('[START] CSI 500 MA5/MA20 screener v6 (valid history auto-fill)')
