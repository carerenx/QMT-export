...
"""
================================================================================
 MiniQMT — QMT day trading v43：趋势分位数反T阈值
================================================================================
 ...
 [run mode]
 python "Stragety/MiniQMT_Stragety/DayT/DayT_v43_QuantileTrendT.py" --mode signal
 python "Stragety/MiniQMT_Stragety/DayT/DayT_v43_QuantileTrendT.py" --mode live
 python "Stragety/MiniQMT_Stragety/DayT/DayT_v43_QuantileTrendT.py" --mode backtest

 python run_bigqmt.py --strategy Stragety\MiniQMT_Stragety\DayT\DayT_v43_QuantileTrendT.py --mode live
================================================================================
"""
...
# Permit the documented ``python Stragety/.../DayT_v43...py`` command.
...
class StrategyRunner:
    """MiniQMT v43 — 趋势分位数下按当日均价重算下一轮触发价。"""

    def __init__(self, dry_run=False):
        logger = get_logger()
        if logger is None:
            logger = FileLogger(STOCK_CODE, version='v43')
            set_logger(logger)
        self.version = 'v43'
    ...
    def run(self):
        ...
        try:
            ...
            _log('[STOP] {} v43 cum {} days gross~Y{:,.0f}'.format(STOCK_NAME, self.total_t_days, self.total_pnl))
            logger = get_logger()
...
def main():
    parser = argparse.ArgumentParser(description='MiniQMT v43 - trend quantile REV-T trigger')
    ...
    logger = FileLogger(STOCK_CODE, version='v43'); set_logger(logger)
