...
"""
================================================================================
 MiniQMT — QMT day trading v47：账户全部持仓做T + ATR重入 + 自适应交易数量
================================================================================

 [v47 改动] (基于 v46 独立策略代码)
 ...
 [run mode]
 python "Stragety/MiniQMT_Stragety/DayT/DayT_v47_AdaptiveTSize.py" --mode signal
 python "Stragety/MiniQMT_Stragety/DayT/DayT_v47_AdaptiveTSize.py" --mode live

 python run_bigqmt.py --strategy Stragety/MiniQMT_Stragety/DayT/DayT_v47_AdaptiveTSize.py --mode live
================================================================================
"""
...
# Permit the documented ``python Stragety/.../DayT_v47...py`` command.
...
class StrategyRunner:
    ...
    def run(self):
        ...
        try:
            ...
            self._log('[STOP] {} v47 cum {} days gross~Y{:,.0f}'.format(self.stock_name, self.total_t_days, self.total_pnl))
...
def main():
    parser = argparse.ArgumentParser(description='v47: portfolio T with ATR reentry and value-based sizing')
    parser.add_argument('--mode', default='signal', choices=['signal', 'live'])
    args = parser.parse_args()
    logger = FileLogger('portfolio', version='v47')
    set_logger(logger)
    try:
        if args.mode == 'live':
