...
from core.drawdown_exposure import DrawdownExposureController, aggressive_policy
...
def main():
    parser = argparse.ArgumentParser(description='v57: aggressive drawdown liquidation')
    ...
    try:
        if args.mode == 'live':
            raise RuntimeError('v57 RESEARCH ONLY: live disabled pending validation')
