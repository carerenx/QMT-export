...
"""
================================================================================
 MiniQMT �� QMT day trading v38 + MOM��ȴʱ����εݼ�
================================================================================
...
# �� v38: MOMƽ��ȷ����ȴ���״�12�룬����ÿ�ֵݼ�2�룬���2�룩
...
class StrategyRunner:
    ...
    def _print_daily_brief(self, signal):
        ...
        if MOM_ENABLED:
            ...
            _log('[MOM-v34] REV��Ȩ{} band {:.2f}% (������REV��ֵ) | ����Ӧ�س�{} {:.2f}~{:.2f}% ATR��{:.2f}'.format(
...
def main():
    parser = argparse.ArgumentParser(description='MiniQMT internal daily Trading v38 �� MOM��ȴʱ����εݼ�')
