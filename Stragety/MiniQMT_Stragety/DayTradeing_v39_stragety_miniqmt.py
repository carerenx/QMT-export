...
"""
================================================================================
 MiniQMT — QMT day trading v39 + MOM冷却时间逐次递减
================================================================================
...
class StrategyRunner:
    """MiniQMT v39 — MOM冷却时间逐次递减 + v36全部机制。"""
    ...
    def _print_daily_brief(self, signal):
        ...
        if MOM_ENABLED:
            ...
            _log('[MOM-v39] REV让权{} band {:.2f}% (仅低于REV阈值) | 自适应回撤{} {:.2f}~{:.2f}% ATR×{:.2f}'.format(
...
def main():
    parser = argparse.ArgumentParser(description='MiniQMT internal daily Trading v39 — MOM冷却时间逐次递减')
