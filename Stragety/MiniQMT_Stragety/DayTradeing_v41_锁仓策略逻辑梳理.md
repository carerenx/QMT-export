...
v41 继承 v40 的 `StrategyRunner`，只增加 MA5/MA20 定时输出，没有重写锁仓逻辑。因此，v41 的锁仓行为实际来自 `DayTradeing_v40_stragety_miniqmt.py`。

相关实现：

- [v41 继承 v40](./DayTradeing_v41_stragety_miniqmt.py#L13)
- [锁仓参数](./core/config.py#L73)
- [强势行情判断函数](./DayTradeing_v40_stragety_miniqmt.py#L1179)
- [主循环调用位置](./DayTradeing_v40_stragety_miniqmt.py#L1915)
...
- [REV-T/FWD-T 空闲态入口](./DayTradeing_v40_stragety_miniqmt.py#L857)
- [REV-T 下单前复核](./DayTradeing_v40_stragety_miniqmt.py#L884)
- [FWD-T 下单前复核](./DayTradeing_v40_stragety_miniqmt.py#L1038)
- [MOM 空闲态入口](./DayTradeing_v40_stragety_miniqmt.py#L1390)
...
调用证据见 [主循环](./DayTradeing_v40_stragety_miniqmt.py#L1842)。
...
实现见 [数据异常锁定](./DayTradeing_v40_stragety_miniqmt.py#L344)。
...
实现见 [涨停保护](./DayTradeing_v40_stragety_miniqmt.py#L355)。
...
相关代码见 [解锁与冷却实现](./DayTradeing_v40_stragety_miniqmt.py#L1192)。
