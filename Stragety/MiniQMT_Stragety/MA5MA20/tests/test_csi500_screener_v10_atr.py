...
PATH = Path(__file__).resolve().parents[1] / 'CSI500_MA5_MA20_Screener_v10_ATR_bigqmt_redis.py'
SPEC = importlib.util.spec_from_file_location('screener_v10_atr', PATH)
