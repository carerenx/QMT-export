...
# 锁仓参数
# ============================================================================
LOCK_PRICE_RATIO  = 0.015       # 价格超过开盘价1.5% cond1
LOCK_MOMENTUM_PCT = 0.010       # 价格浮动1.0% cond2
LOCK_DRAWDOWN_PCT = 0.008
LOCK_LOOKBACK_SEC = 300         # 5分钟内的价格
LOCK_COOLDOWN_SEC = 60         # 锁仓60s
